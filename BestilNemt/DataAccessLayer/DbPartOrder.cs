...
//{
//    class DbPartOrder : IDbPartOrder
//    {
...
//            {
//                conn.Open();
//                var cmd = new SqlCommand("SELECT PartOrder.id, productId, amount, partPrice, cartId FROM Product LEFT JOIN PartOrder ON productId = product.id WHERE productId = @id", conn);
//                cmd.Parameters.AddWithValue("id", id);
...
//                        //PartPrice = reader.GetInt32(reader.GetOrdinal("partPrice")),
